...
elif config.model_type=='ord_reg':
...
def train_fn(data_loader,model,optimizer,device,epoch,writer,df,optimized_rounder=None):
    model.train()
    fin_preds = []
    fin_targets = []
...
def eval_fn(data_loader,model,device,epoch,writer,df,coefficients=None):

...
## To-Do-List 
- [ ] get best threshold for TTA pipeline
- [ ] use TTA to generate weight 
...
| reg | tiles-eb0-netvlad with attention model to select tiles | 0.87 | 0.8859 | 0.8945 | 0.8481 | 1 | 256 | 36 | 25 | 8 TTA only for score model|
